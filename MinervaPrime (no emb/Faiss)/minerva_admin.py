...
def revisar_sugerencias():
    ...
    print(Fore.CYAN + "\n✔️ Revisión finalizada.")
     ...
     # Regenerar los chunks semánticos tras aplicar cambios
    
    print(Fore.YELLOW + "\n🔄 Regenerando semantic_chunks.json tras aplicar cambios...")
    regenerar_chunks(modo="explicativo")
    print(Fore.GREEN + "✅ Chunks regenerados exitosamente.")
