...
def is_unlimited_user(username: str) -> bool:
    ...
    # Un usuario es ilimitado si tiene rol "admin" o plan "ilimitado"
    return info.get("rol") == "admin" or info.get("plan") == "ilimitado"
...
def usos_actuales():
    ...
    usos = {
        **known_defaults,
        **{k.lower(): v for k, v in usos.items()},
    }
